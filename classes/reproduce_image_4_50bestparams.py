        ...
        for wave_id in range(1,n_waves+1):
            ...
            for optimal_pp in optimal_pp_list:
                ...
                for i in tqdm.tqdm(range(reps)):
                    ...
                    cum_inf_data_country /= cum_inf_data_country[T_calibrated-1]
                ...
                plt.fill_between(x = np.arange(len(means)),y1=means - std,y2 = means + std,color = "r", alpha=0.3)
                ...
                plt.savefig(f"./{country}_wave_{wave_id}_rank_{rank}_paper_average_{reps}_full_final.jpg")
